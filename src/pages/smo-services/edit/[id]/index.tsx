...
import { getSmoServiceById, updateSmoServiceById } from 'apiSdk/smo-services';
...
function SmoServiceEditPage() {
  ...
  const handleSubmit = async (values: SmoServiceInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateSmoServiceById(id, values);
      mutate(updated);
      resetForm();
