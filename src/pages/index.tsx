  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of SAQRO, your comprehensive marketing agency providing SEO, EM, SMO, SMM, and SaaS services to elevate your business."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1533750349088-cd871a92f312?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYXJrZXRpbmd8ZW58MHx8fHwxNjk1NjE3MjYxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of SAQRO, your comprehensive marketing agency providing SEO, EM, SMO, SMM, and SaaS services to elevate your business.`}
            </Text>
            <Box
