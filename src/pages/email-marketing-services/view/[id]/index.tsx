...
import { getEmailMarketingServiceById } from 'apiSdk/email-marketing-services';
import { EmailMarketingServiceInterface } from 'interfaces/email-marketing-service';

function EmailMarketingServiceViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Email Marketing Service Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('email_marketing_service', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/email-marketing-services/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Duration"
                  text={data?.duration ? format(parseISO(data?.duration as unknown as string), 'dd-MM-yyyy') : ''}
                />
