...
import { getSaasServiceById } from 'apiSdk/saas-services';
import { SaasServiceInterface } from 'interfaces/saas-service';

function SaasServiceViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Saas Service Details
                  </Text>
                </Box>
                {hasAccess('saas_service', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/saas-services/edit/${id}`} passHref legacyBehavior>
                    <Button
